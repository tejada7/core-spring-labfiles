...
public class LoggingAspect {
	...
	@Pointcut("execution(public * rewards.internal.*.*Repository.find*(..))")
	private void findRepositoryPointCut() {
	}

	@Before("findRepositoryPointCut()")
	...
	@Pointcut("execution(public * rewards.internal.*.*Repository.update*(..))")
	private void updateRepositoryPointCut() {
	}
	...
	@Around("updateRepositoryPointCut()")
