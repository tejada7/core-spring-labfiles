...
public class RestSecurityConfig {
    ...
    public InMemoryUserDetailsManager userDetailsService(PasswordEncoder passwordEncoder) {
		...
		final var user = User.withUsername("user").password(passwordEncoder.encode("user")).roles("USER").build();
		final var admin = User.withUsername("admin").password(passwordEncoder.encode("admin")).roles("ADMIN").build();
		final var superadmin = User.withUsername("superadmin").password(passwordEncoder.encode("superadmin")).roles("SUPERADMIN").build();
