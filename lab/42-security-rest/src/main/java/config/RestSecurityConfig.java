...
public class RestSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public InMemoryUserDetailsManager userDetailsService(PasswordEncoder passwordEncoder) {
        ...
        auth.inMemoryAuthentication()
                ...
                .withUser("superadmin").password(passwordEncoder.encode("superadmin")).roles("SUPERADMIN", "ADMIN", "USER");
    ...
    public Authentication authenticate(Authentication authentication)
       ...
       if (checkCustomAuthenticationSystem(username, password)) {
           return new UsernamePasswordAuthenticationToken(
                   username, password, new ArrayList<>(Arrays.asList((GrantedAuthority) () -> "ROLE_ADMIN")));
       } else {
           return null;
       }
    }
