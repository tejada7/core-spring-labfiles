...
public class ActuatorSecurityConfiguration {
   ...
   public InMemoryUserDetailsManager userDetailsService(PasswordEncoder passwordEncoder) {
       ...
       final var actuator = User.withUsername("actuator").password(passwordEncoder.encode("actuator")).roles("ACTUATOR").build();
       final var admin = User.withUsername("admin").password(passwordEncoder.encode("admin")).roles("ACTUATOR", "ADMIN").build();
