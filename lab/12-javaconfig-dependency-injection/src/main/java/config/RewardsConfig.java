...
public class RewardsConfig {
    ...
    AccountRepository accountRepository() {
        final var jdbcAccountRepository = new JdbcAccountRepository();
    ...
    RestaurantRepository restaurantRepository() {
        final var jdbcRestaurantRepository = new JdbcRestaurantRepository();
    ...
    RewardRepository rewardRepository() {
        final var jdbcRewardRepository = new JdbcRewardRepository();
